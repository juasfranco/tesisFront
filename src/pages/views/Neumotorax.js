                ...
                <div className="right">
                    <div className="infoContainer">
                        <div className="infoCard">
                            <h1 className="infoTitle">Neumotórax</h1>
                            <p className="infoText">
                                El neumotórax es la presencia de aire en el espacio existente entre los pulmones (espacio
                                pleural), que provoca pérdida de volumen pulmonar y colapso del lado afectado.
                            </p>
